...
\usepackage[NU,en]{collegeBeamer}
...
\begin{document}
    ...
    \begin{frame}
        This template is a fork of \bhref{https://www.overleaf.com/latex/templates/the-honk-kong-polytechnic-university-polyu-beamer-presentation-theme/vywngqprjwrq}{The Hong Kong Polytechnic University (PolyU) Beamer Presentation Template} by \bhref{https://t.me/kirun13}{Kirun13} \vspace{\baselineskip}
...
\end{columns}\end{lstlisting}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item If you have corrections or suggestions, \bhref{https://t.me/kirun13}{send them to me!}
        \end{itemize}
    \end{frame}
